...
public class Mape3 {
    public List<Emp> fetchdata() throws Exception {
        ...
        List<Emp> list45=employemap.get("EEE");
        for (Emp ew:list45){
            System.out.println(ew.getId());
            System.out.println(ew.getFIRST_NAME());
            System.out.println(ew.getMIDDLE_NAME());
            System.out.println(ew.getLAST_NAME());
            System.out.println(ew.getAGE());
            System.out.println(ew.getDEPTNAME());
